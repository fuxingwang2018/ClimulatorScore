...
#python main.py -c $HOME/Script/ClimulatorScore/config/Freja/config_${DOMAIN}_${GCM}_DEODE_Freja.yml
#python main.py -c $HOME/Script/ClimulatorScore/config/Freja/config_${DOMAIN}_${VARIABLE}_${GCM}_Freja.yml
