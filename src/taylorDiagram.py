...
class TaylorDiagram(object):
    ...
    def add_contours(self, levels=5, **kwargs):
        ...
        print('self.smin:', self.smin)
        print('self.smax:', self.smax)
        print('ts:', NP.shape(ts), ts)
        print('rs:', NP.shape(rs), rs)
        print('self.refstd**2:', self.refstd**2)
        print('rs**2:', rs**2)
        # Compute centered RMS difference
        rms = NP.sqrt(self.refstd**2 + rs**2 - 2*self.refstd*rs*NP.cos(ts))
        print('rms:', NP.shape(rms), rms)
...
if __name__ == '__main__':
    ...
    dia = test1()
    PLT.savefig('taylorDiagram_test1.png')
    dia = test2()
    PLT.savefig('taylorDiagram_test2.png')
    dia = test3()
    PLT.savefig('taylorDiagram_test3.png')
