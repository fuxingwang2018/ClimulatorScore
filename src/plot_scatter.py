...
experiment = 'SRGAN_TAS_WSMT_SCALETIMESAVED_BS50_LAMB01_DR01_ERAI'
...
#x_file = f"simple_cnn_prediction_normalized_20030815T1200.nc"
#y_file = f"training_singleday/JJA2003_20030815T1200_mrsol_whus_time.nc"
...
label_def = {'xlabel': "Soil Moisture at Top 1cm (mrsol)", 'ylabel': "Surface Air Temperature (tas)"}
title_def = f"{var_names['var2']} vs. {var_names['var1']} ({test_date})"
